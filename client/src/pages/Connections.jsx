...
const Connections = () => {
  ...
  const dataArray = [
    ...
    { label: "Connections", value: Connection, icon: Users },
  ];
  return (
        ...
        <div className="inline-flex flex-wrap items-center border border-gray-200 rounded-md p-1 bg-white shadow-sm">
          {dataArray.map((tab) => (
            ...
            >
              ...
              {tab.count !== undefined && (
                <span className="ml-2 text-xs bg-gray-100 text-gray-700 px-2 py-0.5 rounde-full">
                  {tab.count}
                </span>
              )}
            </button>
            ...
            .value.map((user) => (
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <p className="text-slate-500">{user.bio.slice(0, 26)}....</p>
