             ...
             <div className='max-w-xl bg-white p-4 sm:p-8 sm:pb-3 rounded-xl shadow-md space-y-4'>
                       ...
                       images.length>0 && (<div className='flex flex-wrap gap-2 mt-4'>

                        {
                          ...
                          <div className='relative group'>
                           ...
                           <div  onClick={()=>setImages(images.filter((_,index)=>index !==i))} className='absolute hidden group-hover:flex justify-center items-center top-0 inset-0 bg-black/40 rounded-md cursor-pointer'>
                   ...
                   {/* bottom-bar */}
                     <div className='flex items-center justify-between pt-3 border-t border-gray-300'>
                       ...
                       <input type="file" id="images" accept="ima ge/*" hidden multiple onChange={(e)=>setImages([...images, ...e.target.files])}/>
