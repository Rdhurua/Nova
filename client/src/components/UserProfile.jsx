         ...
         <div className='flex flex-col md:flex-row items-start gap-6'>
            ...
            <div className='w-full pt-16 md:pt-0 md:pl-36'>
                <div className='flex flex-col md:flex-row items-start justify-between'>
                    ...
                    {
                     !profileId && <button 
                     onClick={()=>setShowEdit(true)} className='cursor-pointer flex items-center gap-2 border border-gray-300 hover:bg-gray-50 px-4 py-2 rounded-lg font-medium transition-colors mt-4 md:mt-0'>
                ...
                <div className='flex items-center gap-6 mt-6 border-t border-gray-200 pt-4'>
                  ...
                  <div className='flex flex-col items-center gap-3 shadow p-3'>
