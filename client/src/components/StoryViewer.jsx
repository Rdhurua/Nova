...
const StoryViewer = ({viewStory,setViewStory}) => {
     ...
     const renderContent=()=>{
       switch(viewStory.media_type){
         case 'image':
           ...
           case 'video':
           return(<video controls autoPlay onEnded={()=>setViewStory(null)} src={viewStory.media_url} className='max-h-screen'/>);
  ...
  return (
    <div className='fixed inset-0 h-screen bg-black bg-opacity-90 z-110 flex  items-center justify-center' style={{backgroundColor:viewStory.media_type ==='text'?viewStory.background_color:'#000000'}}>
      ...
      {/* user-info */}
      <div className='absolute top-4 left-4 flex items-center space-x-3 p-2 px-4 sm:p-4 sm:px-8 backdrop-blur-2xl rounded bg-black/40'>
