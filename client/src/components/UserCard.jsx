  ...
  return (
    <div key={user} className='p-4 pt-6 flex flex-col justify-between w-72 shadow border border-gray-200 rounded-md'>
      ...
      <div className='text-center'>
        <img src={user.profile_picture} alt="userprofile"  className='rounded-full w-16 shadow-md mx-auto'/>
      ...
      <div className='flex mt-4 gap-2'>
         ...
         <button onClick={()=>{handleFlow}} disabled={currentUser?.following.includes(user._id)} className='w-full py-2 rounded-md flex justify-center items-center gap-2 bg-gradient-to-r from-indigo-500 to-purple-600
